...
import ThunderboltSection from "@/components/thunderbolt-section";
import CallCounterSection from "@/components/call-counter-section";
import LeadMapSection from "@/components/lead-map-section";
import KovaPricingSection from "@/components/kova-pricing-section";
      ...
      <div className="relative z-10 text-center space-y-12 max-w-5xl mx-auto px-6 py-12">
        ...
        >
          ...
          >
            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed font-medium">
              ...
              for lead qualification, virtual assistants, and business automation.
            </p>
            <p className="text-lg text-muted-foreground/80 leading-relaxed">
              Monitor call flows, track performance, and scale your business — 24/7, powered by Thunderbolt Ultra.
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="group relative inline-flex items-center gap-3 px-8 py-4 bg-primary text-primary-foreground rounded-xl font-semibold text-lg shadow-xl transition-all duration-500 overflow-hidden"
          >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="group relative inline-flex items-center gap-3 px-8 py-4 border-2 border-border/40 rounded-xl font-semibold text-lg hover:border-primary/40 transition-all duration-500 backdrop-blur-xl bg-background/60 hover:bg-background/90 shadow-lg"
          >
            <Zap className="relative z-10 w-5 h-5 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300" />
            <span className="relative z-10 tracking-wide">View Services</span>
          </motion.a>
        </motion.div>
      </div>
    </DotGlobeHero>
